//
//  AppleReverseGeoStoreTests.swift
//  KatsanaSDK
//
...
//class AppleReverseGeoStoreTests: XCTestCase, FailableResourceStoreSpecs {
//    override func setUp() {
//        super.setUp()
...
//
//
//    private func makeSUT(storeURL:URL? = nil, file: StaticString = #file, line: UInt = #line) -> AppleReverseGeoStore {
//        let sut = AppleReverseGeoStore(storeURL: testSpecificStoreURL(), coordinate: (3.0089633, 101.75814))
